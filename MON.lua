...
BullishFractal = low[N] < low[N-2] and 
                 ...
                 low[N] < low[N+1] and
                 low[N] < low[N+2]  
plot_shape(BearishFractal, "BearishFractal", shape_style.triangledown, shape_size.large, "white", shape_location.abovebar, -N, "mon sell", "red") 
plot_shape(BullishFractal, "BullishFractal", shape_style.triangleup, shape_size.large, "white", shape_location.belowbar, -N, "mon buy", "green")
